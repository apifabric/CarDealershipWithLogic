...
resourcename="cardealershipdatabaseiter1"  # lower case, only
resourcegroup="cardealershipdatabaseiter1_rg"
...
# git clone https://github.com/apilogicserver/cardealershipdatabaseiter1.git
# cd cardealershipdatabaseiter1
...
az group create --name cardealershipdatabaseiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group cardealershipdatabaseiter1_rg --sku S1 --is-linux
az container create --resource-group cardealershipdatabaseiter1_rg --name cardealershipdatabaseiter1 --image apilogicserver/cardealershipdatabaseiter1:latest --dns-name-label cardealershipdatabaseiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//cardealershipdatabaseiter1.westus.azurecontainer.io:5656'
