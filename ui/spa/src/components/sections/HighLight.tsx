                ...
                <TableHead>
                  <TableRow>
                    {relatedData.length > 0 &&
                      Object.keys(relatedData[0]).filter(key => !['id', 'ja_type', 'attributes', 'relationships', 'meta'].includes(key)).map((key) => (
                ...
                <TableBody>
                  {relatedData.map((item) => (
                    <TableRow key={item.id}>
                      {Object.keys(item).filter(key => !['id', 'ja_type', 'attributes', 'relationships', 'meta'].includes(key)).map((key) => (
